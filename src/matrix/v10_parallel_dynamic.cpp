/**
 * @file v10_parallel_dynamic.cpp
 * @brief Benchmark runner for OpenMP dynamic-scheduled Cholesky.
 * @details Sweeps matrix sizes while keeping threads and block size fixed,
 * writing three timings per matrix size to CSV.
 */
...
/**
 * @brief Runs the matrix-size benchmark for v10 and saves results to CSV.
 * @return 0 on success, 1 if file output or factorisation fails.
 */
int main() {
    const std::string output_dir = "output";
    const std::string output_file = output_dir + "/v10_parallel_dynamic_matrix_size_runs.csv";
